                ...
                <div>
                    ...
                    <div v-for="(fitem,findex) in taskForm.fval">
                        ...
                        <el-form-item label="商品名称" prop="name">
                            <el-input v-model="fitem.name" type="name"></el-input>
                        </el-form-item>
                        <el-form-item label="商品链接" prop="link">
                            <el-input v-model="fitem.link" type="link"></el-input>
                        </el-form-item>
                                            ...
                                            <el-col>
                                                ...
                                                <div>
                                                    <el-upload
                                                        ...
                                                        <div slot="tip" class="el-upload__tip danger-text">只能上传jpg/png文件，且不超过500kb，且最多只能上传5张</div>
                                                    </el-upload>
                                                </div>
                                            </el-col>
                                        </el-row>
