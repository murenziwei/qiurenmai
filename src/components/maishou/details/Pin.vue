                                ...
                                <el-col :xs="24" :sm="12">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <el-link type="danger" :underline="false">货比词：{{detail.comment_info.than_word||'**'}}</el-link>

                                            <el-link type="danger" :underline="false">搜索词/淘口令：{{detail.comment_info.search_word||'**'}}</el-link>
                                        </li>
                                    </ul>
                                </el-col>
                                <el-col :xs="24" :sm="12">
